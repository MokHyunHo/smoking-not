...
public class FoursquareApp {
	...
	//private static final String TOKEN_URL = "https://foursquare.com/oauth2/authenticate";
	...
	public FoursquareApp(Context context, String clientId, String clientSecret) {
		...
		//mTokenUrl		= AUTH_URL + "&client_id=" + clientId + "&redirect_uri=" + CALLBACK_URL;
	...
	public ArrayList<FsqVenue> getNearby(double latitude, double longitude, int radius) throws Exception {
		...
		try {
			...
			URL url 	= new URL(API_URL + "/venues/search?ll=" + ll + "&intent=browse&radius=" + radius + "&oauth_token=WZ3B1CIMNVEPEEOJ1RNMF32515ETOCCEMRAQPMGFBK0QX4BI&v=20120331");
			//URL url =  new URL("https://api.foursquare.com/v2/venues/search?ll=40.7,-74&oauth_token=WZ3B1CIMNVEPEEOJ1RNMF32515ETOCCEMRAQPMGFBK0QX4BI&v=20120331");
			Log.d(TAG, "Opening URL " + url.toString());
